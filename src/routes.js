...
export default [
  {
    ...
    component: () => <Redirect to={localStorage.getItem('token')===null? '/login' : localStorage.getItem('ChucVu').toString()==="1" ? "/user-management" : localStorage.getItem('ChucVu').toString()==="3"? "/createOrder" : "/"}/>
  },
  {
    path: "/login",
    exact: true,
